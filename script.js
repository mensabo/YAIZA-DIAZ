document.addEventListener('DOMContentLoaded', async () => {
    ...
    // --- FUNCIÓN DE CARGA DE TEXTOS DINÁMICOS Y HABILIDADES ---
        ...
        try {
            ...
            if (docSnap.exists()) {
                ...
                if (pageId === 'homepage') {
                    ...
                    // --- MAGIA PARA LAS HABILIDADES DINÁMICAS ---
                    const skillsContainer = document.getElementById('dynamic-skills-list');
                    if (skillsContainer) {
                        skillsContainer.innerHTML = ''; // Limpiamos el contenedor
                        
                        // Si no hay datos en Firebase, usa los originales que ya tenías
                        ...
                        // Cortamos por las comas y creamos los botones
                ...
                // Carga el resto de los textos normales
